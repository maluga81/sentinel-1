...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to kzcashd "gobject list" output
    ...
    def kzcashd_serialise(self):
        import kzcashlib
        return kzcashlib.SHIM_serialise_for_kzcashd(self.serialise())
